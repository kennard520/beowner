"""
Django settings for beowner project.
...
SECRET_KEY = 'c=9u!^)a-frgf&#kj0v7&*w%0!r%xufw$_z@l=lf+zt&72^q+6'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            # 'environment':'beowner.utils.jinja2_env.environment',
            'context_processors': [
...
WSGI_APPLICATION = 'beowner.wsgi.application'
